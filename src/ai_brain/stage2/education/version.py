...
EDUCATIONAL_LAYER_VERSION = "1.3.0"
EDUCATIONAL_SCHEMA_VERSION = 4
DERIVATION_GRAPH_SCHEMA_VERSION = 4
EXERCISE_SCHEMA_VERSION = 4
GRADING_SCHEMA_VERSION = 4
HINT_POLICY_VERSION = "4.0"
EDUCATIONAL_RENDERING_VERSION = "4.0"
TUTOR_SESSION_SCHEMA_VERSION = 4
EDUCATIONAL_REPLAY_SCHEMA_VERSION = 4
EDUCATIONAL_CATALOG_SCHEMA_VERSION = 4
EXERCISE_GENERATOR_VERSION = "4.0"
SESSION_STORE_SCHEMA_VERSION = 4
EDUCATIONAL_COMPILATION_POLICY_VERSION = "3.0"

INCOMPATIBLE_V1_CATALOG = "REBUILD_REQUIRED_FROM_EDUCATIONAL_V4"
