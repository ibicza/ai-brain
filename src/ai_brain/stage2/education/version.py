...
EDUCATIONAL_LAYER_VERSION = "1.1.0"
EDUCATIONAL_SCHEMA_VERSION = 2
DERIVATION_GRAPH_SCHEMA_VERSION = 2
EXERCISE_SCHEMA_VERSION = 2
GRADING_SCHEMA_VERSION = 2
HINT_POLICY_VERSION = "2.0"
EDUCATIONAL_RENDERING_VERSION = "2.0"
TUTOR_SESSION_SCHEMA_VERSION = 2
EDUCATIONAL_REPLAY_SCHEMA_VERSION = 2
EXERCISE_GENERATOR_VERSION = "2.0"
SESSION_STORE_SCHEMA_VERSION = 2
EDUCATIONAL_COMPILATION_POLICY_VERSION = "1.0"

INCOMPATIBLE_V1_CATALOG = "REBUILD_REQUIRED_FROM_EDUCATIONAL_V2"
