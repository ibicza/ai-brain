...
EDUCATIONAL_LAYER_VERSION = "1.2.0"
EDUCATIONAL_SCHEMA_VERSION = 3
DERIVATION_GRAPH_SCHEMA_VERSION = 3
EXERCISE_SCHEMA_VERSION = 3
GRADING_SCHEMA_VERSION = 3
HINT_POLICY_VERSION = "3.0"
EDUCATIONAL_RENDERING_VERSION = "3.0"
TUTOR_SESSION_SCHEMA_VERSION = 3
EDUCATIONAL_REPLAY_SCHEMA_VERSION = 3
EXERCISE_GENERATOR_VERSION = "3.0"
SESSION_STORE_SCHEMA_VERSION = 3
EDUCATIONAL_COMPILATION_POLICY_VERSION = "2.0"

INCOMPATIBLE_V1_CATALOG = "REBUILD_REQUIRED_FROM_EDUCATIONAL_V3"
