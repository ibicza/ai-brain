"""Compile the M-29.1 v2 educational catalog under offline authority."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--audit",
        type=Path,
        default=Path("runs/m291_compilation/audit.jsonl"),
    )
    parser.add_argument("--entry-count", type=int, default=2_000)
    args = parser.parse_args()
    with tempfile.TemporaryDirectory(prefix="m291-compile-") as directory:
