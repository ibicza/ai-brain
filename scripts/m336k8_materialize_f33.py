    ...
    result = materialize_m336k8_freeze(
        ...
        **(
            ...
            if value["expected_branch"] == M336K13_BRANCH
                ...
                "build_receipt_name": "f37_build_receipt.json",
            }
            if value["expected_branch"] == M336K12_BRANCH
            else {
                ...
                "build_receipt_name": "f36_build_receipt.json",
            }
            if value["expected_branch"] == M336K11_BRANCH
            else {
                "readiness_status": M336K10_READY_STATUS,
                "freeze_role": M336K8FreezeManifest.ROLE_V3,
                "required_components": M336K10_REQUIRED_FREEZE_COMPONENTS,
                "build_receipt_name": "f35_build_receipt.json",
            }
            if value["expected_branch"] == M336K10_BRANCH
            else {
