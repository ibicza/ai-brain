"""Materialize a non-authoritative V5 freeze for pre-Q37 parity."""
...
def main() -> None:
    ...
    if type(value) is not dict or set(value) != expected:
        raise M336K2ProtocolError("M336K12 prospective freeze configuration changed")
    if type(value["component_sources"]) is not dict:
        raise M336K2ProtocolError("M336K12 prospective component map changed")
    ...
    result = materialize_m336k8_freeze(
        ...
        expected_branch=M336K12_BRANCH,
